...
public class SymbolInfoArrays {
  ...
  public List<Double> getMinmovement() {
    return minmovement;
  }

  public void setMinmovement(List<Double> minmovement) {
  ...
  public List<Double> getMinmov2() {
    return minmov2;
  }

  public void setMinmov2(List<Double> minmov2) {
  ...
  public List<Double> getPricescale() {
    return pricescale;
  }

  public void setPricescale(List<Double> pricescale) {
