...
public class TradingPanelOrdersBridgeApi {
  String basePath;
  ApiInvoker apiInvoker = ApiInvoker.getInstance();

  public TradingPanelOrdersBridgeApi(String basePath) {
   ...
   */
  public InlineResponse20010 accountsAccountIdExecutionsGet(String accountId, String instrument, Integer maxCount) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   */
  public void accountsAccountIdExecutionsGet(String accountId, String instrument, Integer maxCount, final Response.Listener<InlineResponse20010> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
   ...
   * @return InlineResponse2004
   */
  public InlineResponse2004 accountsAccountIdOrdersHistoryGet(String accountId, Double maxCount) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   */
  public void accountsAccountIdOrdersHistoryGet(String accountId, Double maxCount, final Response.Listener<InlineResponse2004> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
   ...
   * @return InlineResponse2007
   */
  public InlineResponse2007 accountsAccountIdOrdersOrderIdPut(String accountId, String orderId, Double qty, Double limitPrice, Double stopPrice, Double stopLoss, Double takeProfit, String digitalSignature) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   */
  public void accountsAccountIdOrdersOrderIdPut(String accountId, String orderId, Double qty, Double limitPrice, Double stopPrice, Double stopLoss, Double takeProfit, String digitalSignature, final Response.Listener<InlineResponse2007> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
   ...
   */
  public InlineResponse2005 accountsAccountIdOrdersPost(String accountId, String instrument, Double qty, String side, String type, Double limitPrice, Double stopPrice, String durationType, Double durationDateTime, Double stopLoss, Double takeProfit, String digitalSignature, String requestId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   */
  public void accountsAccountIdOrdersPost(String accountId, String instrument, Double qty, String side, String type, Double limitPrice, Double stopPrice, String durationType, Double durationDateTime, Double stopLoss, Double takeProfit, String digitalSignature, String requestId, final Response.Listener<InlineResponse2005> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
   ...
   * @return InlineResponse2007
   */
  public InlineResponse2007 accountsAccountIdPositionsPositionIdPut(String accountId, String positionId, Double stopLoss, Double takeProfit) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   */
  public void accountsAccountIdPositionsPositionIdPut(String accountId, String positionId, Double stopLoss, Double takeProfit, final Response.Listener<InlineResponse2007> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
