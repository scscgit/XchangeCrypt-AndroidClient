...
formParams.put("takeProfit", ApiInvoker.parameterToString(takeProfit));
  ...
  * Request for bar marks (circles on top of bars). You can display custom marks only in the Trading Terminal
   ...
   * @return MarksArrays
  */
  public MarksArrays marksGet (String symbol, String resolution, BigDecimal from, BigDecimal to) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'symbol' is set
    if (symbol == null) {
  ...
  */
  public void marksGet (String symbol, String resolution, BigDecimal from, BigDecimal to, final Response.Listener<MarksArrays> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public List<TimescaleMark> timescaleMarksGet (String symbol, String resolution, BigDecimal from, BigDecimal to) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'symbol' is set
    if (symbol == null) {
   ...
   * @param symbol Symbol name or ticker   * @param resolution Symbol resolution. Possible resolutions are daily (&#x60;1D&#x60;, &#x60;2D&#x60; ... ), weekly (&#x60;1W&#x60;, &#x60;2W&#x60; ...), monthly (&#x60;1M&#x60;, &#x60;2M&#x60;...) and an intra-day resolution &amp;ndash; minutes(&#x60;1&#x60;, &#x60;2&#x60; ...).   * @param from Unix timestamp (UTC) of the leftmost required bar, including &#x60;from&#x60;.   * @param to Unix timestamp (UTC) of the rightmost required bar, including &#x60;to&#x60;.
  */
  public void timescaleMarksGet (String symbol, String resolution, BigDecimal from, BigDecimal to, final Response.Listener<List<TimescaleMark>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
